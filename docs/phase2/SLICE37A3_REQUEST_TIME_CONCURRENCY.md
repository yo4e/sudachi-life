...
Status: implemented on PR #85; final documentation CI and merge pending.
...
Head `b21c02c82a15a4f0c2bf5353e9fa5db4d2223711`, GitHub Actions run 537:
...
- P2-D11 belongs with the fresh administrative request validator because request creation has no untrusted field input;
