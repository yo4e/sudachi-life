...
This matrix maps Minimal Organism Contract v0.2 §15 evaluations to protected tests. A planned row is not evidence of compliance.
...
| 8. Hard-zero external capabilities | Protected constants implemented; effect tests planned |
...
| 32. Invalid checkpoint not stable | `tests/test_checkpoint.py::test_checkpoint_digest_mismatch_is_rejected`; directory-name mismatch test |
